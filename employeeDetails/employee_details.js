...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById('employeesDetails').innerHTML = 'No se ha encontrado ningun empleado con este ID';
    }
}
...
function findEmployeeBySpecialization(employeeSpecialization) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById('employeesDetails').innerHTML = 'No se ha encontrado ningun empleado con esta especialiacion';
    }
}
